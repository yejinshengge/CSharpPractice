...
public readonly struct OpCodeInfo
{
    ...
    public static readonly Dictionary<OpCode, OpCodeInfo> Infos = new()
    {
        ...
        // 从表中获取值：R(A) = R(B)[RK(C)]
        [OpCode.OpGetTable] = new OpCodeInfo(0, 1, OpArgType.OpArgR, OpArgType.OpArgK, InstructionMode.IABC, "GETTABLE",null),
        ...
        // 设置表值：R(A)[RK(B)] = RK(C)
        [OpCode.OpSetTable] = new OpCodeInfo(0, 0, OpArgType.OpArgK, OpArgType.OpArgK, InstructionMode.IABC, "SETTABLE",null),

        // 创建新表：R(A) = {} (size = B,C)
        [OpCode.OpNewTable] = new OpCodeInfo(0, 1, OpArgType.OpArgU, OpArgType.OpArgU, InstructionMode.IABC, "NEWTABLE",null),
        ...
        [OpCode.OpSetList] = new OpCodeInfo(0, 0, OpArgType.OpArgU, OpArgType.OpArgU, InstructionMode.IABC, "SETLIST",null),
